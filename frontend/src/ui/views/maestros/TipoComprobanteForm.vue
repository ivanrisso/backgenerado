...
<template>
  <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4">
    <h3 class="text-lg font-medium text-gray-900 mb-4">{{ modelValue ? 'Editar' : 'Nuevo' }} Tipo de Comprobante</h3>
    <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div class="flex items-center">
            <input v-model="form.es_fiscal" type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />

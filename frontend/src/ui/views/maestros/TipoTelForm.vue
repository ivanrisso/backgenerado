...
const props = defineProps<{
    modelValue: TipoTel | null;
}>();

const emit = defineEmits<{
    (e: 'submit', entity: TipoTel): void;
    (e: 'cancel'): void;
}>();
...
<template>
  <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4">
    <h3 class="text-lg font-medium text-gray-900 mb-4">{{ modelValue ? 'Editar' : 'Nuevo' }} Tipo de Teléfono</h3>

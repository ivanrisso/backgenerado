    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
        <fieldset :disabled="isDeleteMode" class="disabled:opacity-75 space-y-4">
            <div>
                ...
                <select v-model="form.paisId" @change="onPaisChange" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:cursor-not-allowed disabled:bg-gray-100">

    ...
    <form @submit.prevent="handleSubmit" class="p-6 space-y-4">
        <fieldset :disabled="isDeleteMode" class="disabled:opacity-75 space-y-4">
            <div>
                ...
                <p class="input-helper">Nombre completo de la moneda.</p>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="input-helper">Código único (3 letras).</p>
                </div>
                <div>
                    ...
                    <p class="input-helper">Código para facturación electrónica.</p>
                </div>
            </div>
        </fieldset>
        ...
        <div class="pt-4 flex justify-end gap-3 border-t border-gray-50 mt-6">
            ...
            <button v-if="isDeleteMode" type="submit" class="btn bg-red-600 text-white hover:bg-red-700">Eliminar</button>
            <button v-else type="submit" class="btn btn-primary">Guardar Moneda</button>
        </div>
    </form>
  </div>
</template>

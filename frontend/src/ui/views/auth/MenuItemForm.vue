...
<template>
  <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 mb-6 shadow-sm">
    <h3 class="text-lg font-medium text-gray-900 mb-4">{{ modelValue ? 'Editar' : 'Nuevo' }} Item de Menú</h3>
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-4 bg-white p-3 rounded border border-gray-200">
                <div v-for="role in allRoles" :key="role.id" class="flex items-center">
                    <input type="checkbox" :value="role.id" v-model="form.roleIds" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
